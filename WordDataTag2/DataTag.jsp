<%@ page language="java" import="com.zhuozhengsoft.pageoffice.OpenModeType"
         import="com.zhuozhengsoft.pageoffice.PageOfficeCtrl ,com.zhuozhengsoft.pageoffice.wordwriter.DataTag ,com.zhuozhengsoft.pageoffice.wordwriter.WordDocument,java.text.SimpleDateFormat,java.util.Date"
         pageEncoding="utf-8" %>
<%
    //PageOffice组件的使用
    //设置服务器页面
