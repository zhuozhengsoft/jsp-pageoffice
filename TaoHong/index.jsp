        ...
        <table class="zz-talbe">
            ...
            <tr>
                ...
                <td style="text-align:center;">
                    <a href="javascript:POBrowser.openWindowModeless('edit.jsp' , 'width=1200px;height=800px;');"><span
                            style=" color:Green;">编辑</span></a>&nbsp;&nbsp;&nbsp;
                    <a href="javascript:POBrowser.openWindowModeless('taoHong.jsp' , 'width=1200px;height=800px;');"><span
                            style=" color:Green;">套红</span></a>&nbsp;&nbsp;&nbsp;
                    <a href="javascript:POBrowser.openWindowModeless('readOnly.jsp' , 'width=1200px;height=800px;');"><span
